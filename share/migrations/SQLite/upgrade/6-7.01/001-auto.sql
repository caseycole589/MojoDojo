-- Convert schema '/home/casey/MojoDojo/share/migrations/_source/deploy/6/001-auto.yml' to '/home/casey/MojoDojo/share/migrations/_source/deploy/7.01/001-auto.yml':;

;
BEGIN;

;
ALTER TABLE bills ADD COLUMN amount decimal(9,2) DEFAULT 0.00;
